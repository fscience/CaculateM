...
public class Log4JLogger extends jxl.common.Logger
{
  ...
  {
	  log4jLogger.log(Level.INFO, (String)message);
  }
  ...
  {
	  log4jLogger.log(Level.INFO, (String)message, t);
  }
  ...
  {
	  log4jLogger.log(Level.SEVERE, (String)message);
  }
  ...
  {
	  log4jLogger.log(Level.SEVERE, (String)message, t);
  }
  ...
  {
	  log4jLogger.log(Level.WARNING, (String)message);
  }
  ...
  {
	  log4jLogger.log(Level.WARNING, (String)message, t);
  }
